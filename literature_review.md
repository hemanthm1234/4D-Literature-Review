# Table of Contents
1. [1. LiDARCrafter: Dynamic 4D World Modeling from LiDAR Sequences (AAAI 2026 / arXiv 2025)](#1-lidarcrafter-dynamic-4d-world-modeling-from-lidar-sequences-aaai-2026--arxiv-2025)
2. [2. Sculpt4D: Generating 4D Shapes via Sparse-Attention Diffusion Transformers (arXiv 2026)](#2-sculpt4d-generating-4d-shapes-via-sparse-attention-diffusion-transformers-arxiv-2026)
3. [3. MoRe: Motion-aware Feed-forward 4D Reconstruction Transformer (arXiv 2026)](#3-more-motion-aware-feed-forward-4d-reconstruction-transformer-arxiv-2026)
4. [4. World from Motion: Generative Dynamic Gaussian Reconstruction from Monocular Video (arXiv 2026)](#4-world-from-motion-generative-dynamic-gaussian-reconstruction-from-monocular-video-arxiv-2026)
5. [5. OmniX: Any-view and Any-time 4D Reconstruction via Feed-forward Trajectory Fields (ECCV 2026 / arXiv 2026)](#5-omnix-any-view-and-any-time-4d-reconstruction-via-feed-forward-trajectory-fields-eccv-2026--arxiv-2026)
6. [6. ReViV: Reconstructing the Viewer and the View in 4D from Monocular Egocentric Video (ECCV 2026 / arXiv 2026)](#6-reviv-reconstructing-the-viewer-and-the-view-in-4d-from-monocular-egocentric-video-eccv-2026--arxiv-2026)
7. [7. VistaBot: View-Robust Robot Manipulation via Spatiotemporal-Aware View Synthesis (ICRA 2026 / arXiv 2026)](#7-vistabot-view-robust-robot-manipulation-via-spatiotemporal-aware-view-synthesis-icra-2026--arxiv-2026)
8. [8. CAGS: Color-Adaptive Volumetric Video Streaming with Dynamic 3D Gaussian Splatting (SIGGRAPH 2026 / arXiv 2026)](#8-cags-color-adaptive-volumetric-video-streaming-with-dynamic-3d-gaussian-splatting-siggraph-2026--arxiv-2026)
9. [9. Shape of Motion: 4D Reconstruction from a Single Video (ICCV 2025 / arXiv 2025)](#9-shape-of-motion-4d-reconstruction-from-a-single-video-iccv-2025--arxiv-2025)
10. [10. SV4D: Dynamic 3D Content Generation with Multi-Frame and Multi-View Consistency (ICLR 2025)](#10-sv4d-dynamic-3d-content-generation-with-multi-frame-and-multi-view-consistency-iclr-2025)
11. [11. Learning Physics-Grounded 4D Dynamics with Neural Gaussian Force Fields (ICLR 2026)](#11-learning-physics-grounded-4d-dynamics-with-neural-gaussian-force-fields-iclr-2026)
12. [12. Streaming Visual Geometry Transformer (ICLR 2026 (Under review) / arXiv 2026)](#12-streaming-visual-geometry-transformer-iclr-2026-under-review--arxiv-2026)
13. [13. DeGO: Deformable Gaussian Occupancy: Decoupling Rigid and Nonrigid Motion with Factorized Distillation (ICML 2026 / arXiv 2026)](#13-dego-deformable-gaussian-occupancy-decoupling-rigid-and-nonrigid-motion-with-factorized-distillation-icml-2026--arxiv-2026)
14. [14. Spacetime Gaussian Feature Splatting for Real-Time Dynamic View Synthesis (CVPR 2024 / arXiv 2023)](#14-spacetime-gaussian-feature-splatting-for-real-time-dynamic-view-synthesis-cvpr-2024--arxiv-2023)
15. [15. Real-Time Photorealistic Dynamic Scene Representation and Rendering with 4D Gaussian Splatting (ICLR 2024 / arXiv 2023)](#15-real-time-photorealistic-dynamic-scene-representation-and-rendering-with-4d-gaussian-splatting-iclr-2024--arxiv-2023)
16. [16. Dense RGB SLAM with Neural Implicit Maps (ICLR 2023)](#16-dense-rgb-slam-with-neural-implicit-maps-iclr-2023)
17. [17. Fast Dynamic Radiance Fields with Time-Aware Neural Voxels (SIGGRAPH Asia 2022)](#17-fast-dynamic-radiance-fields-with-time-aware-neural-voxels-siggraph-asia-2022)
18. [18. D-NeRF: Neural Radiance Fields for Dynamic Scenes (CVPR 2021 / arXiv 2020)](#18-d-nerf-neural-radiance-fields-for-dynamic-scenes-cvpr-2021--arxiv-2020)
19. [19. Dynamic Neural Radiance Fields for Monocular 4D Facial Avatar Reconstruction (CVPR 2021 / arXiv 2020)](#19-dynamic-neural-radiance-fields-for-monocular-4d-facial-avatar-reconstruction-cvpr-2021--arxiv-2020)
20. [20. 4D Gaussian Splatting for Real-Time Dynamic Scene Rendering (CVPR 2024 / arXiv 2023)](#20-4d-gaussian-splatting-for-real-time-dynamic-scene-rendering-cvpr-2024--arxiv-2023)
21. [21. Deformable 3D Gaussians for High-Fidelity Monocular Dynamic Scene Reconstruction (CVPR 2024 / arXiv 2023)](#21-deformable-3d-gaussians-for-high-fidelity-monocular-dynamic-scene-reconstruction-cvpr-2024--arxiv-2023)
22. [22. Dream-in-4D: A Unified Approach for Text- and Image-guided 4D Scene Generation (CVPR 2024 / arXiv 2023)](#22-dream-in-4d-a-unified-approach-for-text--and-image-guided-4d-scene-generation-cvpr-2024--arxiv-2023)

---

## Summary of Papers

| Name of the paper | Conference-Year | Main Problem Statement | PS-short |
| :--- | :--- | :--- | :--- |
| 1. LiDARCrafter: Dynamic 4D World Modeling from LiDAR Sequences | AAAI 2026 / arXiv 2025 | Extending LiDAR generation to dynamic 4D world modeling for autonomous driving, which presents challenges in controllability, temporal coherence, and evaluation standardization. | LiDAR-to-4D, 4D-generation |
| 2. Sculpt4D: Generating 4D Shapes via Sparse-Attention Diffusion Transformers | arXiv 2026 | Synthesizing high-fidelity 4D assets from videos, which requires coherent motion and consistent identity while overcoming extreme computational complexity and data scarcity. | Video-to-4D |
| 3. MoRe: Motion-aware Feed-forward 4D Reconstruction Transformer | arXiv 2026 | Fast, generalizable, and robust 4D scene reconstruction from monocular videos, avoiding the high computational cost of optimization methods while handling dynamic objects that corrupt camera pose estimation in streaming or long sequences. | Video-to-4D |
| 4. World from Motion: Generative Dynamic Gaussian Reconstruction from Monocular Video | arXiv 2026 | Synthesizing highly precise, temporally consistent, and freely renderable dynamic 3D representations (4D reconstruction) from monocular video, overcoming the trade-off between geometric rigor and generative expressivity. | Video-to-4D |
| 5. OmniX: Any-view and Any-time 4D Reconstruction via Feed-forward Trajectory Fields | ECCV 2026 / arXiv 2026 | Previous feed-forward 4D reconstruction methods either predict per-frame point clouds (ignoring motion) or track points under limited camera motion, failing to aggregate observations across time and large viewpoint changes. | Video-to-4D |
| 6. ReViV: Reconstructing the Viewer and the View in 4D from Monocular Egocentric Video | ECCV 2026 / arXiv 2026 | Existing egocentric 4D reconstruction methods often treat scene perception and human ego-motion as separate problems, depend heavily on pre-computed camera trajectories or auxiliary priors, and suffer from slow inference time. | Video-to-4D |
| 7. VistaBot: View-Robust Robot Manipulation via Spatiotemporal-Aware View Synthesis | ICRA 2026 / arXiv 2026 | End-to-end robotic manipulation models (like ACT or VLAs) suffer from poor generalization across camera viewpoints, requiring specific camera positions during testing. | Novel-View-Synthesis, Robotics |
| 8. CAGS: Color-Adaptive Volumetric Video Streaming with Dynamic 3D Gaussian Splatting | SIGGRAPH 2026 / arXiv 2026 | Volumetric Video (VV) streaming of 3D Gaussian Splatting (3DGS) consumes significant bandwidth. Existing density-based Level of Detail (LoD) methods cause severe structural gaps at low bitrates, while existing attribute compression (like Vector Quantization) introduces unacceptable color distortions without scalable LoD support. | Volumetric-Video-Streaming |
| 9. Shape of Motion: 4D Reconstruction from a Single Video | ICCV 2025 / arXiv 2025 | Monocular dynamic 4D reconstruction is highly ill-posed, as points move while observed from a single viewpoint. Most methods estimate short-range flow or map points to a canonical space, failing to capture explicit, long-range 3D trajectories persistent over the entire video. | Video-to-4D |
| 10. SV4D: Dynamic 3D Content Generation with Multi-Frame and Multi-View Consistency | ICLR 2025 | Generating dynamic 3D objects (4D generation) from a single monocular video is challenging because it requires simultaneously reasoning about object appearance and motion across unseen views. Existing optimization-based (SDS) methods are slow and suffer from inconsistencies due to independent video and multi-view models. | Video-to-4D |
| 11. Learning Physics-Grounded 4D Dynamics with Neural Gaussian Force Fields | ICLR 2026 | Predicting physical dynamics from visual data requires accurate scene understanding and robust physics reasoning. Existing approaches using 3D Gaussian splatting with traditional physics engines struggle with complex real-world multi-object interactions and prohibitive computational costs. | Multi-view-to-4D, Physics-Simulation |
| 12. Streaming Visual Geometry Transformer | ICLR 2026 (Under review) / arXiv 2026 | State-of-the-art feed-forward 3D reconstruction models (like VGGT) rely on global self-attention across all frames, making them computationally expensive, memory-intensive, and unsuited for streaming/online applications where inputs arrive sequentially. | Video-to-4D, Streaming |
| 13. DeGO: Deformable Gaussian Occupancy: Decoupling Rigid and Nonrigid Motion with Factorized Distillation | ICML 2026 / arXiv 2026 | Existing weakly supervised 3D occupancy prediction methods assume rigid-body motion and rely on simple frame-to-frame offsets. This limits their ability to capture the fine-grained nonrigid deformations of human-centric agents (pedestrians, cyclists) and maintain temporal coherence. | Video-to-4D, 4D-Occupancy-Prediction |
| 14. Spacetime Gaussian Feature Splatting for Real-Time Dynamic View Synthesis | CVPR 2024 / arXiv 2023 | Novel view synthesis of dynamic scenes faces the challenge of simultaneously achieving high-resolution photorealistic results, real-time rendering, and compact storage. | Video-to-4D, Novel-View-Synthesis |
| 15. Real-Time Photorealistic Dynamic Scene Representation and Rendering with 4D Gaussian Splatting | ICLR 2024 / arXiv 2023 | Reconstructing dynamic 3D scenes faces severe scaling challenges when explicitly modeling scene element deformation (like canonical spaces + deformation fields). Existing methods struggle to natively reveal spatial and temporal structure simultaneously. | Video-to-4D, Novel-View-Synthesis |
| 16. Dense RGB SLAM with Neural Implicit Maps | ICLR 2023 | Dense visual SLAM (Simultaneous Localization and Mapping) typically relies on RGB-D sensors. Operating without depth inputs (RGB-only) makes dense map reconstruction highly challenging, especially in featureless regions. | Video-to-3D, RGB-SLAM |
| 17. Fast Dynamic Radiance Fields with Time-Aware Neural Voxels | SIGGRAPH Asia 2022 | Conventional Neural Radiance Fields (NeRF) for dynamic scenes take dozens of hours to optimize. While explicit data structures (like voxel grids) have accelerated static NeRFs, applying them to dynamic scenes is challenging due to the massive memory cost of adding a time dimension and the difficulty of capturing both small and large motions. | Video-to-4D, Novel-View-Synthesis |
| 18. D-NeRF: Neural Radiance Fields for Dynamic Scenes | CVPR 2021 / arXiv 2020 | Standard NeRF achieves unprecedented photorealism but is strictly applicable to static scenes, failing entirely on scenes with moving or deforming objects because it cannot exploit temporal redundancy. | Video-to-4D, Novel-View-Synthesis |
| 19. Dynamic Neural Radiance Fields for Monocular 4D Facial Avatar Reconstruction | CVPR 2021 / arXiv 2020 | Reconstructing 4D facial avatars (handling complex hair, reflections, and subsurface scattering) from monocular video is extremely challenging. Classical mesh-based methods struggle with mouth interiors and hair, while 2D image-based methods lack 3D view-consistency. | Video-to-4D, Facial-Avatar |
| 20. 4D Gaussian Splatting for Real-Time Dynamic Scene Rendering | CVPR 2024 / arXiv 2023 | Representing and rendering dynamic scenes efficiently is challenging. NeRF-based methods are slow. While 3D Gaussian Splatting is fast, extending it to dynamic scenes without a massive memory overhead is difficult. | Video-to-4D, Novel-View-Synthesis |
| 21. Deformable 3D Gaussians for High-Fidelity Monocular Dynamic Scene Reconstruction | CVPR 2024 / arXiv 2023 | Existing implicit neural rendering methods struggle to capture intricate details of objects and fail to achieve real-time rendering in general dynamic scenes. | Video-to-4D, Novel-View-Synthesis |
| 22. Dream-in-4D: A Unified Approach for Text- and Image-guided 4D Scene Generation | CVPR 2024 / arXiv 2023 | Text-to-4D dynamic scene generation is challenging. Relying solely on video diffusion models leads to the Janus problem (multi-view inconsistency) and poor 3D geometry, as video models lack strong 3D awareness. | Text-to-4D, Image-to-4D |
